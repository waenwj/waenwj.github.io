...
const config: Config = {
  ...
  organizationName: 'waenwj', // Usually your GitHub org/user name.
  projectName: 'waenwj.github.io', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/waenwj/waenwj.github.io/blob/master/',
        },
        blog: {
